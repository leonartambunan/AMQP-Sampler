...
public abstract class AbstractRabbitGUI extends AbstractSamplerGui {
    ...
    public void configure(TestElement element) {
        ...
        if (!(element instanceof AbstractRabbitSampler)) return;

        AbstractRabbitSampler sampler = (AbstractRabbitSampler) element;
