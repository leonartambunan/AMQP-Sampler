...
public abstract class AbstractNotificationGUI extends AbstractSamplerGui {
    ...
    private final JCheckBox loggingStatus = new JCheckBox("Logging Active", false);
    ...
    public void configure(TestElement element) {
        ...
        if (!(element instanceof AbstractNotificationSampler)) return;

        AbstractNotificationSampler sampler = (AbstractNotificationSampler) element;
    ...
    public void clearGui() {
        ...
        serverQueue.setText(AbstractRabbitSampler.DEFAULT_LOGON_REQUEST_QUEUE);
        replyToQueue.setText(AbstractRabbitSampler.DEFAULT_LOGON_REPLY_TO_QUEUE);
    ...
    protected Component makeCommonPanel() {
        ...
        queueSettings.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "Login Queues"));
