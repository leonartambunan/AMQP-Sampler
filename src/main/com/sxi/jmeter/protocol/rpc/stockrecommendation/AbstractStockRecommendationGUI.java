...
public abstract class AbstractStockRecommendationGUI extends AbstractRabbitGUI {
    ...
    public String getStaticLabel() {
        return "Trimegah Stock Recommendation Sampler";
    }
    ...
    public void configure(TestElement element) {
        ...
        if (!(element instanceof AbstractStockRecommendation)) return;
        AbstractStockRecommendation sampler = (AbstractStockRecommendation) element;
    ...
    public void clearGui() {
        ...
        sessionId.setText("");
        stockId.setText("BBNI");
        board.setText("RG");
        requestQueue.setText("olt.stock_recommend_request-rpc");
    ...
    protected Component makeCommonPanel() {
        ...
        queueSettings.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "Stock Recommendation Queues"));
