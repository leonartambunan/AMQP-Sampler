...
public abstract class AbstractCurrentMessageGUI extends AbstractRabbitGUI {
    ...
    public String getStaticLabel() {
        return "Trimegah Current Message Sampler";
    }
    ...
    public void configure(TestElement element) {
        ...
        if (!(element instanceof AbstractCurrentMessage)) return;
        AbstractCurrentMessage sampler = (AbstractCurrentMessage) element;
    ...
    protected Component makeCommonPanel() {
        ...
        queueSettings.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "Current Message Queues"));
