...
import com.sxi.jmeter.protocol.amqp.AbstractAMQPSampler;
...
public abstract class AbstractAMQPSamplerGUI extends AbstractSamplerGui {
    ...
    private final JCheckBox exchangeRedeclare = new JCheckBox("Redeclare", AbstractAMQPSampler.DEFAULT_EXCHANGE_REDECLARE);
    ...
    private final JCheckBox exchangeDurable = new JCheckBox("Durable", AbstractAMQPSampler.DEFAULT_EXCHANGE_DURABLE);
    private final JCheckBox queueDurable = new JCheckBox("Durable", true);
    private final JCheckBox queueRedeclare = new JCheckBox("Redeclare", AbstractAMQPSampler.DEFAULT_QUEUE_REDECLARE);
    ...
    public void configure(TestElement element) {
        ...
        if (!(element instanceof AbstractAMQPSampler)) return;
        AbstractAMQPSampler sampler = (AbstractAMQPSampler) element;
    ...
    public void clearGui() {
        exchange.setText("");
        queue.setText("TRIMEGAHQUEUE");
        exchangeDurable.setSelected(AbstractAMQPSampler.DEFAULT_EXCHANGE_DURABLE);
        exchangeRedeclare.setSelected(AbstractAMQPSampler.DEFAULT_EXCHANGE_REDECLARE);
        ...
        queueRedeclare.setSelected(AbstractAMQPSampler.DEFAULT_QUEUE_REDECLARE);

        timeout.setText(AbstractAMQPSampler.DEFAULT_TIMEOUT_STRING);

        host.setText("localhost");
        port.setText(AbstractAMQPSampler.DEFAULT_PORT_STRING);
