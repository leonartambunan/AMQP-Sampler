...
public class AMQPRpc extends AMQPSampler implements Interruptible, TestStateListener {
...
//                    result.setSamplerData("Listen to :\nqueue: " + getQueue()
//                            +"\nrouting key: " + getRoutingKey()
//                            +"\nauto-ack: " + getAutoAck()
//                            +"\nexclusive: " + getQueueExclusive()
//                            +"\nauto-delete: "+getQueueAutoDelete());
    ...
    public boolean autoAck(){
        return getPropertyAsBoolean(AUTO_ACK,true);
    }
    ...
    public boolean getReadResponseAsBoolean() {
        return getPropertyAsBoolean(READ_RESPONSE,true);
    }
